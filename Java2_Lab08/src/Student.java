...
public class Student {
    ...
    Student() { //empty Constructor
        ...
        email = "";
        gpa = 0.0;
        System.out.println("_________________________________"); //Used to make outputs easier to read
    }
    ...
    public void selectDB(int sid) { sql = "SELECT * FROM Students WHERE ID = " + sid;
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:ucanaccess://C:/Users/DefaultTheMighty/IdeaProjects/Java2_Lab08/src/RegistrationDB.mdb"); //connecting driver to the DB
    ...
    public void updateDB() {sql = "UPDATE Students SET Zip = " + getZip() + " WHERE ID = " + getSid();
        try {
            Class.forName("net.ucanaccess.jdbc.UcanaccessDriver"); //Loading the Ucanaccess driver
            Connection connection = DriverManager.getConnection("jdbc:ucanaccess://C:/Users/DefaultTheMighty/IdeaProjects/Java2_Lab08/src/RegistrationDB.mdb"); //connecting driver to the DB
            Statement st = connection.createStatement(); //Creating a statement object
